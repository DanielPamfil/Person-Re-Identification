...
if __name__ == '__main__':
    ...
    logger.info("Start saving DET curve ...")
    fpr, fnr, pos, neg = visualizer.vis_det_curve(args.output)
    visualizer.save_roc_info(args.output, fpr, fnr, pos, neg)
    logger.info("Finish saving DET curve!")
